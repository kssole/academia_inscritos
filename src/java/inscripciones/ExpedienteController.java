...
public class ExpedienteController implements Serializable {
    ...
    @EJB
    private inscripciones.ExpedienteFacade ejbFacade;
    ...
    public static class ExpedienteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Expediente) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ExpedienteController.class.getName());
            }
        }
    }
}
